...
# Set to be true only if development is set to true in environment
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # temporarily log emails to the console so can get the confirmation links
...
# Names must match those in Heroku config vars
